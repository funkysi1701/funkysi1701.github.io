...
cover = ""
keywords = ["tools", "resources", "recommendations", "software development", "DevOps"]
description = "My favorite tools, books, and resources for software development, DevOps, and professional growth. Includes Amazon affiliate links to products I personally use and recommend."
images = []
...
I'm passionate about finding and using tools that improve my productivity and help me deliver better solutions. This page showcases products and resources I genuinely use and recommend. Some links below are Amazon affiliate links, which means I earn a small commission if you purchase through them at no extra cost to you.

## Development & Programming

Books and resources that have shaped my development practice:

### Books

- **[The Pragmatic Programmer: Your Journey to Mastery](https://amzn.to/4pihrvh)** - Essential reading for any developer wanting to improve their craft and adopt best practices
- **[Clean Code: A Handbook of Agile Software Craftsmanship](https://amzn.to/3MbtlbD)** - Robert C. Martin's guide to writing maintainable, professional code
- **[The Phoenix Project: A Novel About IT, DevOps, and Helping Your Business Win](https://amzn.to/4pcQ2dU)** - Learn DevOps principles through an engaging narrative
- **[The DevOps Handbook](https://amzn.to/4pdV6Pd)** - Comprehensive guide to implementing DevOps practices in your organization

### Tools & IDEs

- **Visual Studio Professional** - Comprehensive IDE for .NET development
- **Visual Studio Code** - Lightweight, extensible code editor I use for web development and scripts

### Cloud Platforms

- **Microsoft Azure** - My primary cloud platform for hosting and infrastructure
- **Amazon Web Services (AWS)** - Secondary cloud platform for multi-cloud strategies

### Monitoring & Observability

- **Grafana** - Visualization and monitoring platform
- **Prometheus** - Metrics collection and alerting
- **OpenTelemetry** - Standardized approach to observability
...
- **[NDC London](https://ndclondon.com/)** - Europe's premier software development conference with world-class speakers and diverse tracks
- **[DDD North](https://www.dddnorth.co.uk/)** - My local DDD meetup hosted in Hull every year
- Local tech meetups and community events - Connect with fellow developers and stay current with trends

### Learning Platforms

- **Pluralsight** - Comprehensive video courses for developers and IT professionals

## Affiliate & Referral Programs

I also recommend several services I personally use. 
