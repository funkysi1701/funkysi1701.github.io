...
categories = ["tech"]
keywords = ["", ""]
description = "High Charts is a javascript library that allows graphs and charts to easily be added to web pages. A chart like this can easily be added with a few lines of…"
...
![Highcharts line chart showing solar employment growth by sector](/images/2017/chart.jpeg)
...
![Highcharts solid gauge chart example](/images/2017/chart-1.jpeg)
