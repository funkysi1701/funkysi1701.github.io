...
categories = ["tech"]
keywords = ["", ""]
description = "Azure Table storage is cheap way to store data, however it has some drawbacks that you should be aware of. Azure Table storage is a simple way to store NoSQL…"
