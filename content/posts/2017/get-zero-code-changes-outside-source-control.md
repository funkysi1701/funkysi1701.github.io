+++
title = "Zero code changes outside of git"
...
categories = ["tech"]
keywords = ["", ""]
description = "Source control is bread and butter for web developers, however not so much for SQL developers and other business people."
