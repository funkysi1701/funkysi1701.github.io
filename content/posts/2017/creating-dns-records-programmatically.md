...
categories = ["tech"]
keywords = ["", ""]
description = "DNS is the backbone of the internet. It converts domain names into IP addresses. But how can we do clever things with it?"
...
Azure offers a [SDK](https://learn.microsoft.com/en-us/azure/dns/dns-sdk) and an example Visual Studio project. Let's look at how it works.
