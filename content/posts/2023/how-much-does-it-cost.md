...
categories = ["tech"]
keywords = ["", ""]
description = "How much does it Cost to run my side projects? This is going to be an interesting look at my spending, hopefully it can show you can do a lot without breaking…"
