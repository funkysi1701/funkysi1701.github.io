...
categories = ["tech"]
keywords = ["", ""]
description = "I have been using Azure DevOps (Or VSTS or VSO etc) for a while now and one of the great features is doing automatic builds with every check-in."
