...
categories = ["tech"]
keywords = ["", ""]
description = "While at Microsoft Ignite I heard about a lot of cool tech that I want to know more about. The best way to learn something is use it to solve a problem."
...
I have a Xamarin Forms app Pwned Pass that has over 500 downloads oGoogle Play and over 80 downloads on the Microsoft Store. This has given me a small user base that I can use to make use of whatever I build.
