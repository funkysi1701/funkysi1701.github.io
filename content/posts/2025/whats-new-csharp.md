...
categories = ["tech"]
description = "I was lucky enough to hear Mads Torgersen (The Lead Designer of the C language) speak at NDC London about some of the plans the team has for the next version…"
