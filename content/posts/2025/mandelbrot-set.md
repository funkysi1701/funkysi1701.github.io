...
I have been fascinated by fractals since I was young. I remember seeing them generated on a [Lynx computer](/posts/2021/back-to-basic/). The process was slow, drawing one pixel at a time, and it took a few hours to see a complete Mandelbrot set. More recently, I've generated them in the browser (using .NET's Blazor WebAssembly technology), and the image at the start of this post took only a few seconds to create.
