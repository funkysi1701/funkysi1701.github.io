...
category="tech"
description = "Learn about .NET 10, Blazor WebAssembly changes, and how to fix breaking HttpClient streaming issues in your projects."
...
System.NotSupportedException: net_http_synchronous_reads_not_supported
   at System.Net.Http.BrowserHttpReadStream.Read(:7079/Byte[] buffer, Int32 offset, Int32 count)
   at System.IO.DelegatingStream.Read(:7079/Byte[] buffer, Int32 offset, Int32 count)
   at System.IO.StreamReader.ReadBuffer(:7079/Span`1 userBuffer, Boolean& readToUserBuffer)
   at System.IO.StreamReader.ReadSpan(:7079/Span`1 buffer)
   at System.IO.StreamReader.Read(:7079/Char[] buffer, Int32 index, Int32 count)
   at Newtonsoft.Json.JsonTextReader.ReadData(:7079/Boolean append, Int32 charsRequired)
   at Newtonsoft.Json.JsonTextReader.ReadData(:7079/Boolean append)
   at Newtonsoft.Json.JsonTextReader.ParseValue((index))
   at Newtonsoft.Json.JsonTextReader.Read((index))
   at Newtonsoft.Json.JsonReader.ReadAndMoveToContent((index))
   at Newtonsoft.Json.JsonReader.ReadForType(:7079/JsonContract contract, Boolean hasConverter)
   at Newtonsoft.Json.Serialization.JsonSerializerInternalReader.Deserialize(:7079/JsonReader reader, Type objectType, Boolean checkAdditionalContent)
   at Newtonsoft.Json.JsonSerializer.DeserializeInternal(:7079/JsonReader reader, Type objectType)
   at Newtonsoft.Json.JsonSerializer.Deserialize(:7079/JsonReader reader, Type objectType)
   at Newtonsoft.Json.JsonSerializer.Deserialize[MyResult](:7079/JsonReader reader)
   at MyAPI.Client.MyClient.<ReadObjectResponseAsync>d__57`1[[MyAPI.Client.MyResult, MyAPI.Client, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]].MoveNext((index))
   at MyAPI.Client.MyClient.MyAsync(:7079/MyRequest body, CancellationToken cancellationToken)
