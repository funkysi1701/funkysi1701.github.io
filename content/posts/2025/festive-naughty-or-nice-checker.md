...
categories = ["tech"]
description = "Build a festive Naughty or Nice checker web app using Semantic Kernel, .NET, and OpenAI—explore prompt engineering, plugins, and Blazor integration."
