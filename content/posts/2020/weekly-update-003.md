+++
title = "Weekly update 003: progress notes"
...
categories = ["tech"]
keywords = ["", ""]
description = "Been a quiet week, so wasn't expecting to have much to write on here, however a few things happened worth talking about."
