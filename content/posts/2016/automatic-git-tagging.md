...
categories = ["tech"]
keywords = ["", ""]
description = "One of the features of git is the ability to tag a point in my change history with a tag. For a while now I have been manually tagging my code whenever I do a…"
...
![TeamCity VCS labelling configuration settings](/images/2016/Untitled.jpg)
