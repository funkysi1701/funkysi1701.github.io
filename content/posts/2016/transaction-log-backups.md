...
categories = ["tech"]
keywords = ["", ""]
description = "Like many DBAs I spend a lot of time maintaining my SQL Server backups. From SQL Server I maintain both full backups and transaction log backups."
...
![SQL Server Management Studio restore database dialog](/images/2016/restore1.jpg)
...
![SQL Server point-in-time restore timeline selector](/images/2016/restore2.jpg)
