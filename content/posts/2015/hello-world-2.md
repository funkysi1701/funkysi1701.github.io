...
cover = "/images/2015/01/512px-HelloWorld.svg_1.png"
images =['/images/2015/01/512px-HelloWorld.svg_1.png']
tags = ["Languages", "SourceCode"]
categories = ["tech"]
keywords = ["", ""]
description = "The first program anyone writes in a new language is often really simple and just displays the text “Hello World!”, below are a few examples from languages I…"
