...
categories = ["tech"]
keywords = ["", ""]
description = "For the past few months I have been deploying changes to my companies database every couple of weeks or so. Over a weekend when the database was not being…"
...
![Database deployment workflow diagram](/images/2015/09/deploy.jpg)
