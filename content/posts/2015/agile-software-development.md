...
categories = ["tech"]
keywords = ["", ""]
description = "I have heard the term Agile Software Development quite a bit, but lets see if we can define it and see if I do any of the processes involved with it."
