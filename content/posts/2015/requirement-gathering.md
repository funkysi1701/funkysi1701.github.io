...
categories = ["tech"]
keywords = ["", ""]
description = "Why is it so hard to find out exactly what is needed when designing changes to a system? When adding functionality to databases I always like to dive in and…"
