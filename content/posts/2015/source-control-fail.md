...
categories = ["tech"]
keywords = ["", ""]
description = "Every developer uses source control, it is a great tool for keeping track of changes to your code, seeing who has done what."
...
Troy Hunt has a [blog post](https://www.troyhunt.com/10-commandments-of-good-source-control/) about the 10 commandments of using source control. His number two commandment is “If it’s not in source control, it doesn’t exist” He talks more about code you have written being not saved into source control, but the principal is the same for my example as his.
