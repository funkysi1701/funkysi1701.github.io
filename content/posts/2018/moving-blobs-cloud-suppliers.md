...
categories = ["tech"]
keywords = ["", ""]
description = "We are in the process of moving our companies websites onto the Azure platform. One of the challenges was to move image files out of the website project into…"
