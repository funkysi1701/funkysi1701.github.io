...
categories = ["tech"]
keywords = ["", ""]
description = "DNS is the backbone of the internet and as such I believe every developer should know something about the basics and not just leave it for the sysadmin to sort."
