...
categories = ["tech"]
keywords = ["", ""]
description = "The code base I am working on contains a huge if block. By huge I mean 77 if statements one after the other, each if checks to see what page id you are on and…"
