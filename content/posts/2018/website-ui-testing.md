...
categories = ["tech"]
keywords = ["", ""]
description = "Last week I looked at testing the UI of mobile apps, this week lets look at how we could do a similar thing for websites."
...
[Selenium](https://seleniumhq.org/) started life as a plugin for Firefox to help create automated tests, however the latest version of Firefox is not compatible with the plugin as I write this. I have not had to install any plugins or extensions to my browsers to achieve my testing.
