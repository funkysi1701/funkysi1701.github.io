...
test.describe('Blog Posts and Content', () => {
  test('Individual blog post displays correctly', async ({ page }) => {
    ...
    await test.step('Check that post title is displayed', async () => {
    ...
    await test.step('Verify blog content is readable and formatted', async () => {
    ...
    await test.step('Check for tags at bottom or top of post', async () => {
    ...
    await test.step('Check for reading time estimate', async () => {
